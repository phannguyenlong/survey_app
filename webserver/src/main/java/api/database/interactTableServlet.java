...
public class interactTableServlet extends HttpServlet {
    ...
    private PreparedStatement createStatement(HttpServletRequest req, String action, Connection conn) throws Exception {
        String[] params = null;
        String query = "";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement st = createStatement(req, "dump", conn);
