...
@WebServlet(urlPatterns = "/getAcaFromFaculty")
public class GetAcademicYearsOfFaculty extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String fname =  req.getParameter("fname").isBlank() ? "null" : "'" + req.getParameter("fname") + "'";
        String query = "CALL GetAcademicYearsOfFaculty(" + fname + ") ";
