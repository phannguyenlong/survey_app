...
@WebServlet(urlPatterns = "/questionaire/submit2")
public class submitQuestionaire extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String query = "Call insertIntoQuestionaire('" + class_code + "', '" + lecturer + "','" + questions[1]
                    + "','" + questions[2] + "','" + questions[3] + "','" + questions[4] + "','" + questions[5] + "','"
                    + questions[6] + "','" + questions[7] + "','" + questions[8] + "','" + questions[9] + "','"
                    + questions[10] + "','" + questions[11] + "','" + questions[12] + "','" + questions[13] + "','"
                    + questions[14] + "','" + questions[15] + "','" + questions[16] + "','" + questions[17] + "','"
                    + questions[18] + ");";
